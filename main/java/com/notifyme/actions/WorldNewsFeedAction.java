...
public class WorldNewsFeedAction extends ActionSupport {	
	...
	public String execute() throws IOException {
		...
		URL url=new URL("http://www.moneycontrol.com/rss/internationalmarkets.xml");
		...
		try {
		    ...
		    context.put("worldnewsfeedData",fw.toString()); 
	        stack.push(context);
			fw.close();
		} catch (Exception e) {
			e.printStackTrace();
